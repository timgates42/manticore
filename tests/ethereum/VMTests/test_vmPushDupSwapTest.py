...
class EVMTest_vmPushDupSwapTest(unittest.TestCase):
    ...
    def test_dup3(self):
        ...
        # check storage
        self.assertEqual(
            to_constant(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x03)),
            0x03,
        )
        # check outs
    ...
    def test_swap4(self):
        ...
        # check storage
        self.assertEqual(
            to_constant(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x04)),
            0x01,
        )
        # check outs
        self.assertEqual(returndata, unhexlify(""))
    ...
    def test_swap8(self):
        ...
        # check storage
        self.assertEqual(
            to_constant(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x08)),
            0x01,
        )
        # check outs
        self.assertEqual(returndata, unhexlify(""))
    ...
    def test_swap10(self):
        ...
        # check storage
        self.assertEqual(
            to_constant(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x0A)),
            0x01,
        )
        # check outs
        self.assertEqual(returndata, unhexlify(""))
    ...
    def test_swap11(self):
        ...
        # check storage
        self.assertEqual(
            to_constant(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x0B)),
            0x01,
        )
        # check outs
        self.assertEqual(returndata, unhexlify(""))
    ...
    def test_swap9(self):
        ...
        # check storage
        self.assertEqual(
            to_constant(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x09)),
            0x01,
        )
        # check outs
        self.assertEqual(returndata, unhexlify(""))
    ...
    def test_swap5(self):
        ...
        # check storage
        self.assertEqual(
            to_constant(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x05)),
            0x01,
        )
        # check outs
        self.assertEqual(returndata, unhexlify(""))
    ...
    def test_swap16(self):
        ...
        # check storage
        self.assertEqual(
            to_constant(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x10)),
            0x01,
        )
        # check outs
        self.assertEqual(returndata, unhexlify(""))
    ...
    def test_push32AndSuicide(self):
        ...
        self.assertEqual(
            to_constant(world.get_balance(0xBBCCDDEEFF00112233445566778899AABBCCDDEE)),
            100000000000000000000000,
        )
    ...
    def test_swap2(self):
        ...
        # check storage
        self.assertEqual(
            to_constant(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x02)),
            0x01,
        )
        # check outs
        self.assertEqual(returndata, unhexlify(""))
    ...
    def test_push32Undefined2(self):
        ...
        # check storage
        self.assertEqual(
            to_constant(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x00)),
    ...
    def test_swap14(self):
        ...
        # check storage
        self.assertEqual(
            to_constant(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x0E)),
            0x01,
        )
        # check outs
        self.assertEqual(returndata, unhexlify(""))
    ...
    def test_swap15(self):
        ...
        # check storage
        self.assertEqual(
            to_constant(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x0F)),
            0x01,
        )
        # check outs
        self.assertEqual(returndata, unhexlify(""))
    ...
    def test_swap6(self):
        ...
        # check storage
        self.assertEqual(
            to_constant(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x06)),
            0x01,
        )
        # check outs
        self.assertEqual(returndata, unhexlify(""))
    ...
    def test_swap12(self):
        ...
        # check storage
        self.assertEqual(
            to_constant(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x0C)),
            0x01,
        )
        # check outs
        self.assertEqual(returndata, unhexlify(""))
    ...
    def test_swap13(self):
        ...
        # check storage
        self.assertEqual(
            to_constant(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x0D)),
            0x01,
        )
        # check outs
        self.assertEqual(returndata, unhexlify(""))
    ...
    def test_swap7(self):
        ...
        # check storage
        self.assertEqual(
            to_constant(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x07)),
            0x01,
        )
        # check outs
        self.assertEqual(returndata, unhexlify(""))
